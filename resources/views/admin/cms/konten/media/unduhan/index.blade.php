...
@section('title', 'Unduhan | ' . env('APP_NAME'))
    ...
    <div class="d-flex flex-stack flex-row-fluid">
        <div class="d-flex flex-column flex-row-fluid">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-3 fs-7">
                ...
                <li class="breadcrumb-item text-gray-700">Unduhan</li>
            </ul>
        </div>
        <div class="d-flex align-self-center flex-center flex-shrink-0">
            <div class="me-3">
                ...
                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_filter">
                    ...
                    <div class="px-7 py-5">
                        <div class="mb-10">
                            <label class="form-label fw-semibold">Status Unduhan:</label>
                            <div>
            ...
            <a href="{{ route('prt.apps.unduhan.create') }}" class="btn btn-sm btn-primary d-flex flex-center ms-3 px-4 py-3">
        ...
        @foreach (['Draft' => 'warning', 'Pending Review' => 'info', 'Published' => 'success', 'Scheduled' => 'primary', 'Archived' => 'dark', ' Deleted' => 'danger'] as $label => $color)
            <div class="col-xxl-2 col-lg-4 col-sm-6">
                <div class="card stats-card bg-body hoverable card-xl-stretch mb-xl-8">
                    <div class="card-body">
                        <div class="text-gray-900 fw-bold fs-2 mb-2 mt-5" id="stats_{{ Str::slug($label) }}">{{ \Helper::GetStatistikByModel('Unduhan', $label) }}</div>
        ...
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                <h4 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold fs-3 mb-1">Data Unduhan</span>
            ...
            <div class="card-toolbar">
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-kt-post-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Cari unduhan..." />
                </div>
            </div>
        </div>
...
@push('scripts')
    ...
    <script>
        ...
        var KTDatatablesUnduhan = function() {
            var table;
            var datatable;
            ...
            var initDatatable = function() {
                datatable = $('#datatable').DataTable({
                    ...
                    language: {
                        ...
                        emptyTable: "Tidak ada data unduhan",
                        info: "Menampilkan _START_ sampai _END_ dari _TOTAL_ unduhan",
                        infoEmpty: "Menampilkan 0 sampai 0 dari 0 unduhan",
                        infoFiltered: "(disaring dari _MAX_ total unduhan)",
                        zeroRecords: "Tidak ditemukan data yang sesuai"
                    },
                    ajax: {
                        url: "{{ route('prt.apps.unduhan.index') }}",
                        type: 'GET',
                        data: function(data) {
                            data.filter = {
            ...
            var exportButtons = function() {
                const documentTitle = 'Data Unduhan';
                    ...
                    buttons: [{
                        ...
                        },
                        {
                            ...
                            customize: function(doc) {
                                doc.content[1].table.widths = ['8%', '20%', '15%', '10%', '10%', '10%', '10%', '10%', '10%'];
            ...
            var handleEvents = function() {
                ...
                $(document).on('click', '[data-kt-post-table-select="delete_selected"]', function() {
                    ...
                    Swal.fire({
                        ...
                        text: `Apakah Anda yakin ingin menghapus ${selectedIds.length} unduhan yang dipilih?`,
                        icon: "warning",
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                url: "{{ route('prt.apps.unduhan.destroy.bulk') }}",
                                type: 'POST',
                                data: {
                                    uuids: selectedIds,
                                    _token: "{{ csrf_token() }}"
                ...
                $(document).on('click', "[data-delete]", function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: "{{ route('prt.apps.unduhan.destroy') }}",
                                type: 'POST',
                                data: {
                                    uuid: uuid,
                                    _token: "{{ csrf_token() }}"
