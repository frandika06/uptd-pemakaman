@php
    ...
    $defaultDescription =
        'Website UPTD Pemakaman Dinas Perumahan Permukiman dan Pemakaman Kabupaten Tangerang, Pusat Informasi Tentang Tempat Pemakaman Umum (TPU) dan Layanan Mobil Ambulan Jenazah.';
