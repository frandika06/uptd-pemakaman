...
{{-- ===== CSS LINK ======= --}}
<link rel="stylesheet" href="{{ asset('fe') }}/css/plugins/bootstrap.min.css">
<link rel="stylesheet" href="{{ asset('fe') }}/css/plugins/aos.css">
<link rel="stylesheet" href="{{ asset('fe') }}/css/plugins/fontawesome.css">
<link rel="stylesheet" href="{{ asset('fe') }}/css/plugins/magnific-popup.css">
<link rel="stylesheet" href="{{ asset('fe') }}/css/plugins/mobile.css">
...
{{-- =====  JS SCRIPT LINK ======= --}}
<script src="{{ asset('fe') }}/js/plugins/jquery-3-7-1.min.js"></script>
