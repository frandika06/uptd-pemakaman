...
class PortalActor extends Model
{
    use HasFactory;
    use SoftDeletes;
    use CascadeSoftDeletes;
    public $incrementing      = false;
    protected $table          = "portal_actor";
    protected $primaryKey     = "uuid";
    protected $keyType        = 'string';
    protected $cascadeDeletes = ['RelUserOne'];
    ...
    public function RelUserOne()
    {
        return $this->hasOne('App\Models\User', 'uuid', 'uuid_user');
    }
}