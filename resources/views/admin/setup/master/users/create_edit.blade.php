        ...
        <div class="d-flex flex-column flex-row-fluid">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-3 fs-7">
                ...
                <li class="breadcrumb-item text-gray-700">
                    <a href="{{ route('prt.apps.mst.users.index', [$tags]) }}" class="text-gray-700 text-hover-primary">Users {{ $role }}</a>
                </li>
                <li class="breadcrumb-item">
                    <i class="ki-outline ki-right fs-7 text-gray-700 mx-n1"></i>
                </li>
...
{{-- CONTENT::BEGIN --}}
@section('content')
    <form id="kt_user_form" class="form d-flex flex-column flex-lg-row"
        action="{{ isset($data) ? route('prt.apps.mst.users.update', [$tags, $uuid_enc]) : route('prt.apps.mst.users.store', [$tags]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @isset($data)
            @method('PUT')
        @endisset
                ...
                <div class="card-body pt-0">
                    <div class="d-flex flex-column gap-5">
                        <div class="m-0 p-0">
                            ...
                            <span class="text-gray-800 fw-bold">{{ $role }}</span>
                        </div>
                        <div class="m-0 p-0">
        ...
        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <div class="card-body pt-0">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="nip" class="form-control mb-2 @error('nip') is-invalid @enderror" placeholder="Masukkan NIP atau tanda (-) jika Non ASN"
                                    value="{{ old('nip', isset($data) ? $data->nip : '') }}" autocomplete="off" maxlength="20" autocomplete="off" required />
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="nama_lengkap" class="form-control mb-2 @error('nama_lengkap') is-invalid @enderror" placeholder="Masukkan nama lengkap"
                                    value="{{ old('nama_lengkap', isset($data) ? $data->nama_lengkap : '') }}" autocomplete="off" maxlength="100" required />
                                @error('nama_lengkap')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-10 fv-row">
                                ...
                                <select class="form-select mb-2 @error('jenis_kelamin') is-invalid @enderror" data-control="select2" data-placeholder="Pilih Jenis Kelamin"
                                    ...
                                    <option></option>
                                    <option value="L" {{ old('jenis_kelamin', isset($data) ? $data->jenis_kelamin : '') == 'L' ? 'selected' : '' }}>
                                        Laki-laki</option>
                                    <option value="P" {{ old('jenis_kelamin', isset($data) ? $data->jenis_kelamin : '') == 'P' ? 'selected' : '' }}>
                                        Perempuan</option>
                                </select>
                                @error('jenis_kelamin')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="kontak" class="form-control mb-2 @error('kontak') is-invalid @enderror" placeholder="Masukkan nomor kontak"
                                    value="{{ old('kontak', isset($data) ? $data->kontak : '') }}" autocomplete="off" maxlength="15" required />
                                @error('kontak')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-10 fv-row">
                                ...
                                <input type="email" name="email" class="form-control mb-2 @error('email') is-invalid @enderror" placeholder="Masukkan email"
                                    value="{{ old('email', isset($data) ? $data->email : '') }}" autocomplete="off" maxlength="100" required />
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="mb-10 fv-row">
                        ...
                        <input type="text" name="jabatan" class="form-control mb-2 @error('jabatan') is-invalid @enderror" placeholder="Masukkan jabatan"
                            value="{{ old('jabatan', isset($data) ? $data->jabatan : '') }}" autocomplete="off" maxlength="100" required />
                        @error('jabatan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('prt.apps.mst.users.index', [$tags]) }}" id="kt_user_cancel" class="btn btn-light me-5">
